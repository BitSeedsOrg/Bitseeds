...
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector  -Wno-unused-variable -Wno-format-extra-args -Wno-unused-local-typedefs
