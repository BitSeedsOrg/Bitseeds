...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\BitSeeds-New
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\BitSeeds-New
    // Mac: ~/Library/Application Support/BitSeeds-New
    // Unix: ~/.BitSeeds-New
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitSeeds-New";
#else
    fs::path pathRet;
