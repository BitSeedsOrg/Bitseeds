...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About BitSeeds"), this);
    aboutAction->setStatusTip(tr("Show information about BitSeeds"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitSeeds"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitSeeds addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitSeeds addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your BitSeeds addresses"));
