...
*/
    ...
    aboutAction = new QAction(tr("&About BitSeeds"), this);
...
static QWidget* makeToolBarSpacer()
{
    ...
    spacer->setStyleSheet(fUseBlackTheme ? "QWidget { background: rgb(87,75,40); }" : "QWidget { background: none; }");
    return spacer;
}
...
void BitcoinGUI::createToolBars()
{
    ...
    if (fUseBlackTheme)
    {
        ...
        header->setStyleSheet("QWidget { background-color: rgb(87,75,40); background-repeat: no-repeat; background-image: url(:/images/header); background-position: top center; }");
...
void BitcoinGUI::gotoloungePage()
{
    ...
    if (!loungeInit)
    {
        loungePage->findChild<QWebView *>("webView")->load(QUrl("https://kiwiirc.com/client/irc.freenode.net/#bitseeds"));
        loungeInit = true;
    }
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    if (nLastCoinStakeSearchInterval && nWeight)
    {
        ...
        nNetworkWeight /= COIN;
        float nInterestRate;
        nInterestRate = COIN_YEAR_REWARD / CENT;
