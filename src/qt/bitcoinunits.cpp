...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XSEED");
    case mBTC: return QString("mXSEED");
    case uBTC: return QString::fromUtf8("μXSEED");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BitSeedss"));
    case mBTC: return QString(QObject::tr("Milli-BitSeedss (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BitSeedss (1 / 1,000,000)"));
    default: return QString("???");
    }
}
